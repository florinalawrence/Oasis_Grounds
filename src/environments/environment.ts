export const environment = {
  ...
  RECAPTCHA_V3_SITE_KEY :'6LcsIDgpAAAAAHJdxH7kJjusau8Kk8Z4vVQoCYk6',
  
  // Development API for all features
  baseApiUrl:'https://jmrpropertiesapi.techneatsolutions.com/jmr-properties-api/v1/',
  authApiUrl:'https://jmrpropertiesapi.techneatsolutions.com/jmr-properties-api/v1/',
